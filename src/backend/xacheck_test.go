...
func TestWriteXaCommitErrorLogAddXidDuplicate(t *testing.T) {
...
func TestReadXaCommitErrorLogsWithoutBackend(t *testing.T) {
	...
	file := path.Join(scatter.txnMgr.xaCheck.dir, xacheckJSONFile)
...
func TestReadXaCommitRrrLogsInit(t *testing.T) {
	...
	file := path.Join(MockScatter3Default(log).XaCheckDir, xacheckJSONFile)
