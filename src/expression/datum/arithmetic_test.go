...
func TestAdd(t *testing.T) {
	tcases := []struct {
	...
	}{
		{
			v1:     NewDNull(true),
			v2:     NewDInt(1, false),
			field:  &IField{IntResult, 0, false},
			resTyp: TypeNull,
			resStr: "0",
		},
		{
		...
		},
		{
			...
			field:  &IField{DecimalResult, 2, false},
			resTyp: TypeDecimal,
			resStr: "4",
		},
		{
		...
		},
		{
			v1:     NewDFloat(1.23),
			v2:     NewDDecimal(decimal.NewFromFloat(2.77)),
			field:  &IField{RealResult, NotFixedDec, false},
			resTyp: TypeFloat,
			resStr: "4",
		},
		{
...
func TestMul(t *testing.T) {
	tcases := []struct {
...

		{
			v1:     NewDDecimal(decimal.NewFromFloat(1.23)),
			v2:     NewDDecimal(decimal.NewFromFloat(2.77)),
			field:  &IField{DecimalResult, 4, false},
			resTyp: TypeDecimal,
			resStr: "3.4071",
		},
		{
			...
			v1:    NewDInt(2, true),
			v2:    NewDDecimal(decimal.NewFromFloat(math.MaxFloat64)),
			field: &IField{DecimalResult, 0, true},
...
func TestDiv(t *testing.T) {
	tcases := []struct {
		...
		},
		{
			v1:    NewDFloat(math.MaxFloat64),
			v2:    NewDString("0.5"),
			field: &IField{RealResult, 0, true},
